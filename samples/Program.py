...
class TestApp(TestWrapper, TestClient):
    ...
    def tickDataOperations_req(self):
        ...
        # ! [reqetfticks]
        self.reqMktData(
            1019, ContractSamples.etf(), "mdoff,576,577,578,623,614", False, False, []
        )
        # ! [reqetfticks]
    ...
    def optionsOperations_req(self):
        ...
        self.exerciseOptions(
            5003, ContractSamples.OptionWithTradingClass(), 1, 1, self.account, 1
        )
        # ! [exercise_options]
    ...
    def whatIfOrderOperations(self):
        ...
        self.placeOrder(
            self.nextOrderId(), ContractSamples.USStockAtSmart(), whatIfOrder
        )
        # ! [whatiflimitorder]
        time.sleep(2)
